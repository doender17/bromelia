# -*- coding: utf-8 -*-
"""
    bromelia.lib.etsi_3gpp_gx.messages
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class CreditControlAnswer(DiameterAnswer):
    ...
    Usage::
        ...
        >>> from bromelia.lib.etsi_3gpp_gx import CCA
        >>> cca = CCA()
        >>> cca
...
class CreditControlRequest(DiameterRequest):
    ...
    Usage::
        ...
        >>> from bromelia.lib.etsi_3gpp_gx import CCR
...
class ReAuthAnswer(DiameterAnswer):
    ...
    Usage::
        ...
        >>> from bromelia.lib.etsi_3gpp_gx import RAA
        >>> raa = RAA()
        >>> raa
...
class ReAuthRequest(DiameterRequest):
    ...
    Usage::
        ...
        >>> from bromelia.lib.etsi_3gpp_gx import RAR
        >>> rar_avps = {
        ...     "destination_realm": "remote"
        ... }
        >>> rar = RAR(**rar_avps)
