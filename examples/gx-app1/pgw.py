...
if __name__ == "__main__":
    ...
    attrs = {
        ...
        "user_equipment_info" : [UserEquipmentInfoTypeAVP(USER_EQUIPMENT_INFO_TYPE_IMEISV), UserEquipmentInfoValueAVP("3507310119985311")],
        ...
        "x3gpp_sgsn_mcc_mnc": X3gppSgsnMccMncAVP("26203"),
        ...
        "called_station_id" : "vip.onephone.de",
        ...
        "access_network_charging_identifier" : AccessNetworkChargingIdentifierGxAVP([AccessNetworkChargingIdentifierValueAVP(b"\x01\x55\x55\x73")]),
    }
